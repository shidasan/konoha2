...
static void opcode_check(void)
{
	...
	assert(sizeof(klr_NNMOV_t) <= sizeof(kopl_t));
	assert(sizeof(klr_NSET2_t) <= sizeof(kopl_t));
	assert(sizeof(klr_NSET3_t) <= sizeof(kopl_t));
	assert(sizeof(klr_NSET4_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iINC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iDEC_t) <= sizeof(kopl_t));
	...
	assert(sizeof(klr_iAND_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iOR_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iXOR_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iLSFT_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iRSFT_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iADDC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iSUBC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iMULC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iDIVC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iMODC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iEQC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iNEQC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iLTC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iLTEC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iGTC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iGTEC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iANDC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iORC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iXORC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iLSFTC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iRSFTC_t) <= sizeof(kopl_t));
	...
	assert(sizeof(klr_fADDC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fSUBC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fMULC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fDIVC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fEQC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fNEQC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fLTC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fLTEC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fGTC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fGTEC_t) <= sizeof(kopl_t));
	...
	assert(sizeof(klr_OSET2_t) <= sizeof(kopl_t));
	assert(sizeof(klr_OSET3_t) <= sizeof(kopl_t));
	assert(sizeof(klr_OSET4_t) <= sizeof(kopl_t));
	assert(sizeof(klr_CHKSTACK_t) <= sizeof(kopl_t));
	assert(sizeof(klr_LDMTD_t) <= sizeof(kopl_t));
	assert(sizeof(klr_SCALL_t) <= sizeof(kopl_t));
	assert(sizeof(klr_VCALL_t) <= sizeof(kopl_t));
	assert(sizeof(klr_VCALL__t) <= sizeof(kopl_t));
	assert(sizeof(klr_iCAST_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fCAST_t) <= sizeof(kopl_t));
	assert(sizeof(klr_JMP__t) <= sizeof(kopl_t));
	assert(sizeof(klr_NGETIDX_t) <= sizeof(kopl_t));
	assert(sizeof(klr_NSETIDX_t) <= sizeof(kopl_t));
	assert(sizeof(klr_NGETIDXC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_NSETIDXC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_OGETIDX_t) <= sizeof(kopl_t));
	assert(sizeof(klr_OSETIDX_t) <= sizeof(kopl_t));
	assert(sizeof(klr_OGETIDXC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_OSETIDXC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_bJNUL_t) <= sizeof(kopl_t));
	assert(sizeof(klr_bJNN_t) <= sizeof(kopl_t));
	assert(sizeof(klr_bJNOT_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJEQ_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJNEQ_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJLT_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJLTE_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJGT_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJGTE_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJEQC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJNEQC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJLTC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJLTEC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJGTC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_iJGTEC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJEQ_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJNEQ_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJLT_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJLTE_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJGT_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJGTE_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJEQC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJNEQC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJLTC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJLTEC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJGTC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_fJGTEC_t) <= sizeof(kopl_t));
	assert(sizeof(klr_CHKIDX_t) <= sizeof(kopl_t));
	assert(sizeof(klr_CHKIDXC_t) <= sizeof(kopl_t));
}
