...
static void CSock_init(CTX, kRawPtr *po, void *conf)
{
	errno = 0;
}

static void CSock_free(CTX, kRawPtr *po)
{
	errno = 0;
}
...
static	kbool_t socket_initPackage(CTX, struct kKonohaSpace *ks, int argc, const char**args, kline_t pline)
{
...
static kbool_t socket_setupPackage(CTX, struct kKonohaSpace *ks, kline_t pline)
{
	return true;
}
...
static kbool_t socket_setupKonohaSpace(CTX, struct kKonohaSpace *ks, kline_t pline)
{
	return true;
}
